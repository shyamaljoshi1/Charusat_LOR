import { Card, CardHeader, CardBody, Heading, Input, FormControl } from '@chakra-ui/react'

const ResultDetails = ({ onChange }) => {
    return (
            ...
            <CardBody margin={"3rem 0 4rem 6rem"}>
                <table width={'100%'}>
                    <tbody>
                        ...
                        >
                            <td style={{ flex: '.5', fontSize: '1.3rem', maxWidth: '6rem' }}>Semester</td>
                            <td style={{ flex: '1', textAlign: 'center', fontSize: '1.3rem' }}>1<sup>st</sup>Sem</td>
                            <td style={{ flex: '1', textAlign: 'center', fontSize: '1.3rem' }}>2<sup>nd</sup>Sem</td>
                            <td style={{ flex: '1', textAlign: 'center', fontSize: '1.3rem' }}>3<sup>rd</sup>Sem</td>
                            <td style={{ flex: '1', textAlign: 'center', fontSize: '1.3rem' }}>4<sup>th</sup>Sem</td>
                            <td style={{ flex: '1', textAlign: 'center', fontSize: '1.3rem' }}>5<sup>th</sup>Sem</td>
                            <td style={{ flex: '1', textAlign: 'center', fontSize: '1.3rem' }}>6<sup>th</sup>Sem</td>
                            <td style={{ flex: '1', textAlign: 'center', fontSize: '1.3rem' }}>7<sup>th</sup>Sem</td>
                            <td style={{ flex: '1', textAlign: 'center', fontSize: '1.3rem' }}>8<sup>th</sup>Sem</td>
                        </tr>
                        <tr
                            style={{ display: 'flex', marginBottom: '1rem', alignItems: 'center' }}
                        >
