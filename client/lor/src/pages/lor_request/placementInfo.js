                ...
                >
                    ...
                    <RadioGroup defaultValue='2' margin={"1rem 0rem 0rem 3rem"} >
                        <Stack spacing={5} direction='column'>
                            ...
                            <FormHelperText color='red' margin='.7rem 1rem'>{error.placeThroughCdpc}</FormHelperText>
                            {cdpc &&
                    ...
                    <FormControl>
                        ...
                        <RadioGroup defaultValue='2' margin={"1rem 0rem 0rem 3rem"} >
                            ...
                            <FormHelperText color='red' margin='.7rem 0rem'>{error.bondCompleted}</FormHelperText>
                        </RadioGroup>
                    </FormControl>
                </FormControl>
            </CardBody>
