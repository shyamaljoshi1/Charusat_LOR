import { Card, CardHeader, CardBody, Heading, Input, FormLabel, FormControl, FormHelperText } from '@chakra-ui/react'
        ...
        <Card margin={"7rem 7rem 4rem 5rem"}>
            ...
            <CardBody margin={"3rem 0 4rem 6rem"}>
                ...
                >
                    ...
                    <FormHelperText color='red' margin='.7rem 1rem'>{error.studentId}</FormHelperText>
                ...
                >
                    ...
                    <FormHelperText color='red' margin='.7rem 1rem'>{error.studentName}</FormHelperText>
                </FormControl>
                <FormControl
                    display={"flex"}
                    marginTop={"2rem"}
                ...
                >
                    ...
                    <Input onChange={onChange} name="emailId" type="email" width={"25rem"} size={"lg"} variant="outline" borderColor={"#1B65A7"} fontSize={"1.4rem"} />
                    <FormHelperText color='red' margin='.7rem 1rem'>{error.emailId}</FormHelperText>
                </FormControl>
                <FormControl
                    display={"flex"}
                    marginTop={"2rem"}
                ...
                >
                    ...
                    <FormHelperText color='red' margin='.7rem 1rem'>{error.studentMobile}</FormHelperText>
                </FormControl>
                <FormControl
                    display={"flex"}
                    marginTop={"2rem"}
                ...
                >
                    ...
                    <FormHelperText color='red' margin='.7rem 1rem'>{error.parentMobile}</FormHelperText>
                ...
                >
                    ...
                    <FormHelperText color='red' margin='.7rem 1rem'>{error.passoutDate}</FormHelperText>
